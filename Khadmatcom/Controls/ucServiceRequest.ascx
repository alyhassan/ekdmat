                    ...
                    <div class="col-md-12">
                     ...
                     <li><a data-toggle="collapse" data-parent="#accordion500" href="#collapse502">بيانات الشحن </a></li>--%>
                        ...
                        <ul class="nav nav-bar  col-lg-2 col-md-2 col-xs-6 col-sm-3 navbar-left">
                            <li class="text-success text-left" dir="rtl">000 ريال</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="accordion clearfix" id="accordion500">
                    <div class="panel">
                        <div class="clearfix fal">
                            <div class="accordion-heading">طالب الخدمة &nbsp;   <i class="indi fa fa-chevron-up"></i></div>

                        </div>
                        <div id="collapse500" class="collapse in validationEngineContainer" aria-expanded="false">
                            <div class="accordion-body clearfix">
                               <div class="row ">
                                    <div class="col-md-12 col-xs-12 form-group arabic-r">
                                        ...
                                        <div class="form-group  col-md-2 col-sm-4 col-xs-12  pull-right">
                                            <label class="col-md-12">محافظة</label>
                                        ...
                                        <div class=" form-group col-md-12 col-md-12 col-xs-12 form-group arabic-r">
                                            <label>تفاصيل</label>
                                            <textarea rows="5" class="form-control" runat="server" id="txtDetails"></textarea>
                                        </div>
                                        <!--</div>-->
                                    </div>
                                </div>
                                <div class="col-md-12 col-xs-12 form-group arabic-r">
                                    ...
                                    <div class="clearfix">
                                            ...
                                            <div class="form-group col-md-4 col-sm-4 col-xs-12 o1 options">
                                                <label>اسم مدير المحتوى</label>
                                                <input type="text" class="form-control" runat="server" id="txtManagerName" />
                                            </div>
                                            <div class="form-group o2 options col-md-4 col-sm-4 col-xs-12 col-md-6 col-sm-6 col-xs-12">
                                                <label>رقم الهوية</label>
                                                <input type="text" class="form-control" runat="server" id="txtManagerIdentityNumber" />
                                            </div>
                                            <div class="form-group o3 options col-md-4 col-sm-4 col-xs-12">
                                                <label>ايميل</label>
                                                <input type="text" class="form-control  validate[custom[email]]" runat="server" id="txtManagerEmail" />
                                            </div>
                                            <div class="form-group options col-md-4 col-sm-4 col-xs-12 o5">
                                                <label>رقم ملف مكتب العمل</label>
                                                <input type="text" class="form-control" runat="server" id="txtWorkOfficeNumber" />
                                            </div>
                                            <div class="form-group options col-md-4 col-sm-4 col-xs-12 o6">
                                                <label>رقم ال 700 للشركة</label>
                                                <input type="text" class="form-control" runat="server" id="txt700Number" />
                                            </div>

                                            <div class="form-group o4 options col-md-4 col-sm-4 col-xs-12">
                                                <label>رقم جوال مدير المحتوى</label>
                                                <input type="text" class="form-control" runat="server" id="txtManagerPhone" />
                                            </div>
                                    ...
                                    <div class="clearfix">
                                        <div class="col-md-12">
                                            <div class="form-group options col-md-4 col-sm-4 col-xs-12 o17">
                                            ...
                                            <div class="form-group options col-md-4 col-sm-4 col-xs-12 pull-right o46">
                                                <label for="ddlPortName">أسم المنفذ الجمركى </label>
                                            ...
                                            <div class="form-group options col-md-4 col-sm-4 col-xs-12 pull-right o60">
                                                <label for="ddlWorkCap">حجم الأعمال </label>
                                            ...
                                            <div class="form-group options col-md-4 col-sm-4 col-xs-12 pull-right o51">
                                                <label for="ddlCompanyType">نوع كيان المؤسسة</label>
                                            ...
                                            <div class="form-group options col-md-6 col-sm-6 col-xs-12 o28">
                                            ...
                                            <div class="form-group options col-md-6 col-sm-6 col-xs-12 o95">
                                                <input type="text" class="form-control" runat="server" id="txtIstkdam" placeholder="الإستقدام" />
                                            </div>
                                            <div class="form-group options col-md-6 col-sm-6 col-xs-12 o96">
                                    ...
                                    <div class="clearfix">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group options  col-md-4 pull-right o63">
                                                <label for="chkAccount">هل لديك نظام محاسبى</label>
                                                <input type="checkbox" id="chkAccount" runat="server" />
                                            </div>
                                            <div class="form-group options  col-md-4 pull-right o61">
                                            ...
                                            <div class="form-group options  col-md-4 pull-right o85">
                                            ...
                                            <div class="form-group options  col-md-4 pull-right o40">
                                            ...
                                            <div class="form-group options  col-md-4 pull-right o71">
                                            ...
                                            <div class="form-group options  col-md-4 pull-right o72">
                                            ...
                                            <div class="form-group options  col-md-4 pull-right o56">
                                            ...
                                            <div class="form-group options  col-md-4 pull-right o23">
                                            ...
                                            <div class="form-group options  col-md-4 pull-right o73">
                                            ...
                                            <div class="form-group options  col-md-4 pull-right o8">
                                                <label for="chkGarag">هل يتوفر حوش إيواء </label>
                                                <input type="checkbox" id="chkGarag" runat="server" />
                                            </div>
                                            <div class="form-group options  col-md-4 pull-right o41">
                                            ...
                                            <div class="form-group options  col-md-4 pull-right o39">
                                            ...
                                            <div class="form-group options col-md-6 col-sm-6 col-xs-12 o18">
                                            ...
                                            <div class="form-group options col-md-6 col-sm-6 col-xs-12 o93">
