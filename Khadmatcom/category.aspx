<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="category.aspx.cs" Inherits="Khadmatcom.category" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="server">
    <ul class="nav nav-tabs nav-arow myTab">
        ...
        <li class="sub active alif"><a href="javascript:{}"><%= CategoryName %></a></li>
    </ul>

    <div id="main" class="tab-pane fade in active">
        <div id="" class="owl-demo owl-carousel owl-theme">
            <asp:ListView runat="server" ID="lvCategories" SelectMethod="GetSubcategories" ItemPlaceholderID="PlaceHolder1" GroupItemCount="12" ItemType="Khadmatcom.Services.Model.ServiceSubcategory">
                <GroupTemplate>
                ...
                <ItemTemplate>
                    <a href="<%# GetLocalizedUrl(string.Format("{0}/{1}/{2}/{3}/services",sectionName,Item.ServiceCategory.UrlName,Item.UrlName,Item.Id)) %>" title="<%# Item.Name %>" class="">
