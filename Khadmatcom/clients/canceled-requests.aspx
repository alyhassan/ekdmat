<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="canceled-requests.aspx.cs" Inherits="Khadmatcom.clients.canceled_requests" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="server">
    <ul class="nav nav-tabs nav-arow myTab">
        ...
        <li class="sub active alif"><a href="javascript:{}">طلبات ملغاة</a></li>
    </ul>
