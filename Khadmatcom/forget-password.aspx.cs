        ...
        protected void btnRegister_OnClick(object sender, EventArgs e)
        {
                ...
                Dictionary<string, string> keysValues = new Dictionary<string, string>
            {
                ...
                try
                {
                    ...
                    RedirectAndNotify(Request.RawUrl,"تم ارسال كلمة المرور الخاصة بك على بريدك الإلكتروني المسجل لدينا");
                }
                catch (Exception ex)
                {
                    // todo:log the exception
                    Server.ClearError();
                    RedirectAndNotify(Request.RawUrl, "حدث خطأ أثناء استعادة كلمة المرور",notificationType:NotificationType.Error);
