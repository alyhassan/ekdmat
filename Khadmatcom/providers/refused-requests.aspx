<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="refused-requests.aspx.cs" Inherits="Khadmatcom.providers.refused_requests" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="server">
  <ul class="nav nav-tabs nav-arow myTab">
        ...
        <li class="sub active alif"><a href="javascript:{}">خدمات مرفوضة</a></li>
